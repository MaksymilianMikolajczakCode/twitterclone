...
const RightSidebar = () => {
  return (
    <section className="w-[25%] hidden sticky overflow-scroll top-2 mt-2 lg:flex flex-col items-stretch h-screen px-6">
    <div>
      <div className="relative w-full h-full group"> 
        <input id="searchBox"
          type="text"
          placeholder="Search Twitter"
          className="outline-none peer focus:border-primary focus:border bg-neutral-900/90 w-full h-full rounded-xl py-6 pl-14 pr-4"
        >
        </input>
    ...
    <div className="flex flex-col rounded-xl bg-neutral-900 my-4">
      <h3 className="font-bold text-xl my-4 px-4">What is happening</h3>
      <div>
        ...
        {Array.from({ length:3}).map((_,i) => (
          ...
          >
            <div className="flex items-center space-x-2">
              <div className="w10 h-10 bg-neutral-600 rounded-full flex-none"></div>
