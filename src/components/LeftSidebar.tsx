...
const LeftSidebar = () => {
  return (
    ...
    <button className='rounded-full flex items-center space-x-2 m-4 bg-transparent p-4 text-2xl text-center hover:bg-opacity-70 transition duration-200 w-full justify-between'>
